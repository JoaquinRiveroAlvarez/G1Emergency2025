...
namespace G1Emergency2025.BD.Datos
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MovilEvento>()
                .HasKey(me => new { me.MovilId, me.EventoId });
            ...
            modelBuilder.Entity<TipoEstadoEvento>()
                .HasKey(eu => new { eu.EventoId, eu.TipoEstadoId });
