...
namespace Proyecto2025.Server.Controllers
{
    ...
    public class TripulanteController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<Tripulante>>> GetList()
        {
        ...
        [HttpPost]
        public async Task<ActionResult<int>> Post(Tripulante causa)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult> Put(int id, Tripulante DTO)
        {
        ...
        [HttpDelete("{id:int}")]
        public async Task<ActionResult> Delete(int id, Tripulante causa)
        {
