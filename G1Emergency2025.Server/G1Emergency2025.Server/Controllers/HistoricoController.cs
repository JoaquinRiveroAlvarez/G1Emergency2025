...
namespace Proyecto2025.Server.Controllers
{
    ...
    public class HistoricoController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<int>> Post(Historico causa)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult> Put(int id, Historico DTO)
        {
        ...
        [HttpDelete("{id:int}")]
        public async Task<ActionResult> Delete(int id, Historico causa)
        {
